...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button numeroZero, numeroUm, numeroDois, numeroTres,
            ...
            numeroOito, numeroNove, ponto, potencia, divisao, multiplicacao,
            soma, subtracao, igual, botao_limpar;
    private TextView txtExpressao, txtResultado;
    private ImageView backspace, raiz;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        raiz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txtResultado.setText(String.valueOf(Math.sqrt(x)));
            }
        });
    }
